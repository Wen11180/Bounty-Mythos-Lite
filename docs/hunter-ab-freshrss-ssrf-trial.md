# FreshRSS SSRF package trial (ssrf family)

Generated: 2026-07-13T01:30:08Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-freshrss-feed-ssrf-lab | my-gh-freshrss-feed-ssrf-lab | refute | skipped_no_gold | ready | 0 | 2 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-freshrss-feed-ssrf-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-freshrss-feed-ssrf-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-freshrss-feed-ssrf-lab (lab / ssrf)
...
- `H-001` → `refuted` root=`missing_ssrf_validation:create_local_freshrss_feed` duplicate_of=`None` evidence=['code:code.ts:validateUrlForSSRF']
- `H-002` → `refuted` root=`missing_ssrf_validation:refresh_local_freshrss_feed` duplicate_of=`None` evidence=['code:code.ts:validateUrlForSSRF']
