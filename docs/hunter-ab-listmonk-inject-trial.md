...
Generated: 2026-07-12T15:18:56Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-listmonk-campaign-inject-lab | my-gh-listmonk-campaign-inject-lab | refute | skipped_no_gold | ready | 0 | 2 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-listmonk-campaign-inject-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-listmonk-campaign-inject-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-listmonk-campaign-inject-lab (lab / injection)
...
- `H-001` → `refuted` root=`missing_injection_validation:preview_local_listmonk_campaign_query` duplicate_of=`None` evidence=['code:code.ts:makeSearchString']
- `H-002` → `refuted` root=`missing_injection_validation:search_local_listmonk_campaigns` duplicate_of=`None` evidence=['code:code.ts:makeSearchString']
