...
Generated: 2026-07-12T13:59:55Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-paperless-doc-authz-lab | my-gh-paperless-doc-authz-lab | refute | skipped_no_gold | ready | 0 | 3 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-paperless-doc-authz-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-paperless-doc-authz-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-paperless-doc-authz-lab (lab / authorization)
...
- `H-001` → `refuted` root=`missing_object_ownership_check:delete_local_paperless_document` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
- `H-002` → `refuted` root=`missing_object_ownership_check:get_local_paperless_document` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
- `H-003` → `refuted` root=`missing_object_ownership_check:update_local_paperless_document` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
