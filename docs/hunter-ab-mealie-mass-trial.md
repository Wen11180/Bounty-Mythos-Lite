...
Generated: 2026-07-12T15:01:49Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-mealie-user-mass-lab | my-gh-mealie-user-mass-lab | refute | skipped_no_gold | ready | 0 | 2 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-mealie-user-mass-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-mealie-user-mass-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-mealie-user-mass-lab (lab / mass_assignment)
...
- `H-001` → `refuted` root=`missing_mass_assignment_guard:update_local_mealie_admin_self` duplicate_of=`None` evidence=['code:code.ts:assert_user_change_allowed']
- `H-002` → `refuted` root=`missing_mass_assignment_guard:update_local_mealie_self_user` duplicate_of=`None` evidence=['code:code.ts:assert_user_change_allowed']
