...
2. Continue Phase 3 with a deeper semantic-quality target:
   improve source-fact heuristics for aliased dependencies, `Security(...)`, multi-line decorators/signatures, multi-hop service calls, ownership checks, and impact reasoning while keeping outputs advisory.
