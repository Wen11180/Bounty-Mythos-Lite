...
1. Continue Phase 3 with a deeper semantic-quality target:
   improve source-fact heuristics for deeper dependency-wrapper chains, deeper or ambiguous service call chains, additional ORM variants, and richer impact reasoning while keeping outputs advisory.
