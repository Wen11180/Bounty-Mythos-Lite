...
1. Continue Phase 3 with a deeper semantic-quality target:
   improve source-fact heuristics for deeper dependency-wrapper chains, multi-hop service calls, broader ownership predicates, and impact reasoning while keeping outputs advisory.
