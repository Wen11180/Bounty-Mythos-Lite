...
Generated: 2026-07-12T10:53:30Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-gitea-issue-authz-lab | my-gh-gitea-issue-authz-lab | refute | skipped_no_gold | ready | 0 | 1 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-gitea-issue-authz-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-gitea-issue-authz-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-gitea-issue-authz-lab (lab / authorization)
...
- `H-001` → `refuted` root=`missing_object_ownership_check:get_local_gitea_issue` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
