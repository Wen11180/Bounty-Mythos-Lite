...
Generated: 2026-07-12T14:57:23Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-cal-booking-authz-lab | my-gh-cal-booking-authz-lab | refute | skipped_no_gold | ready | 0 | 3 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-cal-booking-authz-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-cal-booking-authz-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-cal-booking-authz-lab (lab / authorization)
...
- `H-001` → `refuted` root=`missing_object_ownership_check:get_local_cal_booking` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
- `H-002` → `refuted` root=`missing_object_ownership_check:edit_local_cal_booking_location` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
- `H-003` → `refuted` root=`missing_object_ownership_check:confirm_local_cal_booking` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
