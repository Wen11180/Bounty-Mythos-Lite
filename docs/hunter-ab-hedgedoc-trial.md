...
Generated: 2026-07-12T14:11:01Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-hedgedoc-note-authz-lab | my-gh-hedgedoc-note-authz-lab | refute | skipped_no_gold | ready | 0 | 3 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-hedgedoc-note-authz-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-hedgedoc-note-authz-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-hedgedoc-note-authz-lab (lab / authorization)
...
- `H-001` → `refuted` root=`missing_object_ownership_check:delete_local_hedgedoc_note` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
- `H-002` → `refuted` root=`missing_object_ownership_check:get_local_hedgedoc_note` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
- `H-003` → `refuted` root=`missing_object_ownership_check:update_local_hedgedoc_note` duplicate_of=`None` evidence=['code:code.ts:owner_id_filter']
