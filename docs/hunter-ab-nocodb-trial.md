...
Generated: 2026-07-12T14:07:01Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-nocodb-record-authz-lab | my-gh-nocodb-record-authz-lab | refute | skipped_no_gold | ready | 0 | 3 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-nocodb-record-authz-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-nocodb-record-authz-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-nocodb-record-authz-lab (lab / authorization)
...
- `H-001` → `refuted` root=`missing_object_ownership_check:delete_local_nocodb_records` duplicate_of=`None` evidence=['code:code.ts:group_id_filter']
- `H-002` → `refuted` root=`missing_object_ownership_check:get_local_nocodb_records` duplicate_of=`None` evidence=['code:code.ts:group_id_filter']
- `H-003` → `refuted` root=`missing_object_ownership_check:update_local_nocodb_records` duplicate_of=`None` evidence=['code:code.ts:group_id_filter']
