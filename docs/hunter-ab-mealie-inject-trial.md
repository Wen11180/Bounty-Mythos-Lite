# Mealie inject package trial (injection family)

Generated: 2026-07-12T20:46:30Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-mealie-recipe-inject-lab | my-gh-mealie-recipe-inject-lab | refute | skipped_no_gold | ready | 0 | 2 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-mealie-recipe-inject-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-mealie-recipe-inject-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-mealie-recipe-inject-lab (lab / injection)
...
- `H-001` → `refuted` root=`missing_injection_validation:filter_local_mealie_recipes` duplicate_of=`None` evidence=['code:code.ts:sql_sanitize']
- `H-002` → `refuted` root=`missing_injection_validation:search_local_mealie_recipes` duplicate_of=`None` evidence=['code:code.ts:makeSearchString']
