...
Generated: 2026-07-12T15:25:01Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-cal-webhook-ssrf-lab | my-gh-cal-webhook-ssrf-lab | refute | skipped_no_gold | ready | 0 | 2 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-cal-webhook-ssrf-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-cal-webhook-ssrf-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-cal-webhook-ssrf-lab (lab / ssrf)
...
- `H-001` → `refuted` root=`missing_ssrf_validation:deliver_local_cal_webhook` duplicate_of=`None` evidence=['code:code.ts:validateUrlForSSRF']
- `H-002` → `refuted` root=`missing_ssrf_validation:test_local_cal_webhook` duplicate_of=`None` evidence=['code:code.ts:validateUrlForSSRF']
