...
Generated: 2026-07-12T20:41:54Z
...
| --- | --- | --- | --- | --- | --- | --- |
| my-gh-immich-user-mass-lab | my-gh-immich-user-mass-lab | refute | skipped_no_gold | ready | 0 | 1 |

## Decision quality (machine)

| case_id | expected | decision_quality | note |
| --- | --- | --- | --- |
| my-gh-immich-user-mass-lab | refute | pass | inspect evaluator notes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| my-gh-immich-user-mass-lab | (none) | n/a | n/a | n/a | n/a | n/a | n/a | human | correct empty retain set |

## my-gh-immich-user-mass-lab (lab / mass_assignment)
...
- `H-001` → `refuted` root=`missing_mass_assignment_guard:update_local_immich_me` duplicate_of=`None` evidence=['code:code.ts:forbid_privilege_fields']
