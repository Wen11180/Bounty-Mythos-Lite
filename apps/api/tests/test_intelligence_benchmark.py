...
def test_build_studio_expectations_template_preserves_ab_required_artifacts():
    ...
    assert template["expected_candidates"][0]["require_policy_review"] is True
    assert template["expected_candidates"][0]["require_evidence_review"] is True
    assert template["expected_candidates"][0]["require_provenance_review"] is True
    ...
    assert template["expected_candidates"][0]["require_validation_review"] is True
...
def test_evaluate_studio_candidates_requires_policy_risk_when_expected():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_policy_risk",
    } in result["failures"]
    assert {
        "name": "file export authz gap",
        "reason": "missing_policy_risk_score",
    } in result["failures"]


def test_evaluate_studio_candidates_rejects_high_policy_risk_when_expected():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
    ...
    assert {
        "name": "file export authz gap",
        "reason": "policy_risk_too_high:75",
    } in result["failures"]


def test_evaluate_studio_candidates_requires_policy_review_when_marked_required():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_policy_review",
    } in result["failures"]


def test_evaluate_studio_candidates_accepts_policy_review_items():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
...
def test_evaluate_studio_candidates_requires_evidence_review_when_marked_required():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
...
def test_evaluate_studio_candidates_accepts_evidence_review_required_items():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
...
def test_evaluate_studio_candidates_requires_provenance_review_when_marked_required():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_provenance_review",
    } in result["failures"]


def test_evaluate_studio_candidates_accepts_provenance_review_artifact_kinds():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
...
def test_evaluate_studio_candidates_requires_deduplication_review_when_marked_required():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_deduplication_review",
    } in result["failures"]


def test_evaluate_studio_candidates_accepts_deduplication_review_items():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
...
def test_evaluate_studio_candidates_requires_validation_review_when_marked_required():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_validation_review",
    } in result["failures"]


def test_evaluate_studio_candidates_accepts_validation_review_gate():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
...
def test_evaluate_studio_candidates_matches_review_keywords_across_punctuation():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
                    ...
                    "refutation_status": "unverified",
                    "duplicate_risk_score": 10,
                    "evidence_needed": ["Review the invite-policy route handler."],
                    "false_positive_checks": [
                        "Confirm administrator-only enforcement in the downstream-service."
                    ],
                    "safe_validation_plan": ["Use local role fixtures only"],
                    "safety_blockers": [
                        "execute_live_validation",
            ...
            "expected_candidates": [
                {
                    ...
                    "required_artifacts": ["scope", "policy", "code", "api", "har"],
                    "required_evidence_keywords": ["invite policy"],
                    "required_false_positive_keywords": ["downstream service"],
                }
            ]
        },
    )
...
def test_evaluate_studio_candidates_requires_fuzzing_artifacts_to_stay_advisory():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
            ...
            "expected_candidates": [
                {
                    ...
                    "vuln_type": "authorization_gap",
                    "code_path": "routes.py",
                    "required_artifacts": ["code", "api", "har", "fuzzing"],
                }
            ]
        },
    )
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_advisory_signal:fuzzing",
    } in result["failures"]


def test_evaluate_studio_candidates_requires_strategy_artifacts_to_stay_advisory():
    result = evaluate_studio_candidates(
        {
            "candidates": [
                {
            ...
            "expected_candidates": [
                {
                    ...
                    "vuln_type": "authorization_gap",
                    "code_path": "routes.py",
                    "required_artifacts": ["code", "api", "har", "strategy"],
                }
            ]
        },
    )
    ...
    assert {
        "name": "file export authz gap",
        "reason": "missing_advisory_signal:strategy",
    } in result["failures"]
