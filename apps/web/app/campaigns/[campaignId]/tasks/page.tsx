    ...
    <main className="min-h-screen px-5 py-6 sm:px-8 lg:px-10">
      ...
      <header className="mt-6 border-b border-[var(--line)] pb-6">
        ...
        <p className="mt-2 max-w-2xl text-pretty text-[var(--muted)]">
          Review-only research work items with assigned reviewer, status, and provenance counts.
        </p>
      </header>
      ...
      {summaries.length === 0 ? (
        <section className="mt-6 border border-[var(--line)] bg-white p-6">
          <p className="flex items-center gap-2 text-sm font-semibold text-[var(--warning)]">
            ...
            No research review items ready
          </p>
          <p className="mt-2 max-w-2xl text-pretty text-[var(--muted)]">
            Research review items will appear here when Mythos prepares review-only work.
          </p>
        </section>
      ) : (
